...
::Ok, so this is pretty horrible. PhantomJS requires Node to be in PATH, so we have to force it in for the install to work, so temporarily install it into path...
SET ORIGINAL_PATH=%PATH%
SET NODE_PATH=%NODE_EXE:node.exe=%
path %path%;%NODE_PATH%
